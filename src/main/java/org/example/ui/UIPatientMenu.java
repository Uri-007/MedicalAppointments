...
public class UIPatientMenu {
    ...
    private static void showBookAppointmentMenu() {
        ...
        do {
            ...
            if(response == 1) {
                UIMenu.patientLogged.addAppoinmentDoctors(doctorSelected, doctorSelected.getAvailableAppointments().get(indexDate).getDate(null), doctorSelected.getAvailableAppointments().get(indexDate).getTime());
    ...
    private static void showPatientMyAppointments() {
        ...
        do {
            ...
            for (int i = 0; i < UIMenu.patientLogged.getAppoinmentDoctors().size(); i++) {
                int j = i + 1;
                System.out.println(j + ". " + "Date: " + UIMenu.patientLogged.getAppoinmentDoctors().get(i).getDate() + "Time: " + UIMenu.patientLogged.getAppoinmentDoctors().get(i).getTime() + "Doctor: " + UIMenu.patientLogged.getAppoinmentDoctors().get(i).getDoctor().getName());
            }
